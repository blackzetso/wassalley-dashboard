            ...
            <div class="card-body">
                <div class="row align-items-md-center gx-md-5">
                    ...
                    <div class="col-4 pt-2">
                        ...
                        <span>{{\App\CentralLogics\translate('price')}} :
                        ...
                        <span>{{\App\CentralLogics\translate('discount')}} :
                            <span>{{\App\CentralLogics\Helpers::discount_calculate($product,$product['price'])}} {{\App\CentralLogics\Helpers::currency_symbol()}}</span>
                        </span><br>
                        <span>
                            {{\App\CentralLogics\translate('available')}} {{\App\CentralLogics\translate('time')}} {{\App\CentralLogics\translate('starts')}} : {{$product['available_time_starts']}}
                        </span><br>
                        <span>
                            {{\App\CentralLogics\translate('available')}} {{\App\CentralLogics\translate('time')}} {{\App\CentralLogics\translate('ends')}} : {{$product['available_time_ends']}}
                        </span>
                        ...
                        @foreach(\App\Model\AddOn::whereIn('id',json_decode($product['add_ons'],true))->get() as $addon)
                            <span class="text-capitalize">
                              {{$addon['name']}} : {{$addon['price']}} {{\App\CentralLogics\Helpers::currency_symbol()}}
                            </span><br>
                        @endforeach
                    </div>
