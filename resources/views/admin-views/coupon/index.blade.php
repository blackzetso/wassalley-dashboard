                ...
                <div class="card">
                    <div class="card-header">
                        <div class="flex-start">
                            <h5 class="card-header-title">Coupon Table</h5>
                    ...
                    <div class="table-responsive datatable-custom">
                        <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                            ...
                            <tr>
                                ...
                                <th></th>
                                <th colspan="3">
{{--                                    <input type="text" id="column1_search" class="form-control form-control-sm" placeholder="{{\App\CentralLogics\translate('search')}}">--}}
