...
<div class="modal-body">
    <div class="d-flex flex-row">
        ...
        <div class="d-flex align-items-center justify-content-center active" style="height:9.5rem;">
            <img class="img-responsive" style="height:100%;width:auto;overflow:hidden;border-radius: 5%;"
                src="{{ asset($item_type == 'product' ? 'storage/app/public/product' : 'storage/app/public/campaign') }}/{{ $product['image'] }}"
    ...
    as $key => $add_on)
                ...
                <div class="d-flex justify-content-between mt-2">
                    ...
                    <button class="btn btn-sm btn-primary" onclick="update_order_item()" type="button"
                        style="width:37%;">
                        <i class="tio-edit"></i>
