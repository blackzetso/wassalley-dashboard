    ...
    <div class="d-flex flex-row">
        ...
        <div class="details pl-2">
            <span class="product-name"><a href="#"
                                          class="h3 mb-2 product-title">{{ Str::limit($product->name, 100) }}</a></span>
            ...
            @if($product->discount > 0)
                <div class="mb-3 text-dark">
                    ...
                    <strong
                            id="set-discount-amount">{{\App\CentralLogics\Helpers::discount_calculate($product, $product->price) . ' ' . \App\CentralLogics\Helpers::currency_symbol()}}</strong>
                </div>
            @endif
        <!-- Product panels-->
