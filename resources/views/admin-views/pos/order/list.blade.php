            ...
            <div class="table-responsive datatable-custom">
                <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                    ...
                    <tr>
                      ...
                      <th>{{\App\CentralLogics\translate('order')}} {{\App\CentralLogics\translate('branch')}}</th>
...
?>
                               @foreach($order->details as $detail)
                                 @if($detail['product'])
                                      ...
                                      <?php
                                          ...
                                          $adds_on +=  \App\Model\AddOn::where(['id' =>$id])->first()->price ;
                                      ?>
                              ...
                              {{ $order->order_amount + $order['delivery_charge']   . " " . \App\CentralLogics\Helpers::currency_symbol()}}</td>
                          ...
                          <td>
                          	@php
                            $branch=App\Model\Branch::find($order['branch_id']);
                            if($branch){
