<div style="width:410px;">
    ...
    <div class="row mt-3">
        ...
        @if($order->customer)
            <div class="col-12">
                <h5>{{\App\CentralLogics\translate('Customer Name')}}
                    : {{$order->customer['f_name'].' '.$order->customer['l_name']}}</h5>
                ...
                <tr>
                    ...
                    <td class="">
                        ...
                        @foreach(json_decode($detail['add_on_ids'],true) as $key2 =>$id)
                            ...
                            @php($add_ons_cost+=$addon['price'] * (int)$add_on_qty  )
                        @endforeach

                        {{\App\CentralLogics\translate('Discount')}}
                        : {{$detail['discount_on_product']*$detail['quantity'] .' '.\App\CentralLogics\Helpers::currency_symbol()}}
                    </td>
                    <td style="width: 28%">
    ...
    <div class="row justify-content-md-end">
        <div class="col-md-7 col-lg-7">
            <dl class="row text-right" style="color: black!important;">
                ...
                <dt class="col-6">{{\App\CentralLogics\translate('Tax')}} / {{\App\CentralLogics\translate('VAT')}}:
                </dt>
                ...
                <dd class="col-6"
                    style="font-size: 20px">{{$order->order_amount +$order['delivery_charge']  ." ".\App\CentralLogics\Helpers::currency_symbol()}}</dd>
            </dl>
        </div>
    </div>
