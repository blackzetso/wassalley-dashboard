            ...
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="{{route('admin.dashboard')}}" aria-label="Front" style="padding-top: 0!important;padding-bottom: 0!important;">
                    <img class="navbar-brand-logo"
                         ...
                         src="{{asset('storage/app/public/product')}}/"
                         alt="Logo">
                </a>
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img"
                                        ...
                                        src="{{asset('storage/app/public/branch')}}/"
                                        alt="Image">
                    ...
                    <div class="card-header d-flex flex-wrap justify-content-between ">
                        <form id="search-form" class="header-item">
                            ...
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch" type="search" value="{{$keyword?$keyword:''}}" name="search" class="form-control" placeholder="{{\App\CentralLogics\translate('Search here')}}" aria-label="Search here">
                            </div>
                            <!-- End Search -->
                        </form>
                    ...
                    <div class="card">
                        <div class="row m-0">
                            <div class="col-12 p-1">
                                <select onchange="store_key('branch_id',this.value)" id='branch' name="branch_id" class="branch-data-selector form-control">
                                    <option selected disabled>{{\App\CentralLogics\translate('Select Branch')}}</option>
                          ...
                          <div class="col-12 p-1">
                                <select onchange="store_key('delivery_man_id',this.value)" id='delivery' name="delivery_man_id" class="delivery-data-selector form-control">
                                    <option selected disabled>{{\App\CentralLogics\translate('Select delivery man')}}</option>
                                    @foreach($deliveries as $branch)
                                        <option value="{{$branch['id']}}">{{$branch['f_name']}} {{$branch['l_name']}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12 p-1">
...
<script>
 ...
 var valueCurrent = parseFloat(element.val());
    ...
    $('.delivery-data-selector').select2();     
