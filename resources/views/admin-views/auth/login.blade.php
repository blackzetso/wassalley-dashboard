                        ...
                        <form class="js-validate" action="{{route('admin.auth.login')}}" method="post">
                            ...
                            <div class="text-center">
                                <div class="mb-5">
                                    ...
                                    <p>{{\App\CentralLogics\translate('want')}} {{\App\CentralLogics\translate('to')}} {{\App\CentralLogics\translate('login')}} {{\App\CentralLogics\translate('your')}} {{\App\CentralLogics\translate('branches')}}?
                            ...
                            <div class="js-form-message form-group">
                                <label class="input-label text-capitalize" for="signinSrEmail">{{\App\CentralLogics\translate('your')}} {{\App\CentralLogics\translate('email')}}</label>
