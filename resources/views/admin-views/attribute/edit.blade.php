        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i> {{\App\CentralLogics\translate('attribute')}} {{\App\CentralLogics\translate('update')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                            ...
                            <div class="col-12">
                                @foreach(json_decode($language) as $lang)
                                    ...
                                    <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                        ...
                                        <input type="text" name="name[]" class="form-control" value="{{$lang==$default_lang?$attribute['name']:($translate[$lang]['name']??'')}}" placeholder="New Attribute" {{$lang == $default_lang? 'required':''}}>
                                    </div>
