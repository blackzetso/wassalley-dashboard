            ...
            <div class="d-flex justify-content-end">
                ...
                <ul class="list-inline list-separator">
                    <li class="list-inline-item">
                        <a class="list-separator-link" href="{{route('admin.business-settings.restaurant-setup')}}">{{\App\CentralLogics\translate('restaurant')}} {{\App\CentralLogics\translate('settings')}}</a>
                    </li>
